_base_ = [
    ...
    # '../../../../_base_/datasets/custom_no_wingscale.py'
    # '../../../../_base_/datasets/custom_wingscale_only.py'
...
channel_cfg = dict(
    num_output_channels=n_points, # 98
    dataset_joints=n_points,
    dataset_channel=[
        list(range(n_points)),
    ],
    inference_channel=list(range(n_points)))
